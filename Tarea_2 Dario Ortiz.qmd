...
plt.plot(x, p_1, label="P1: 1 + x", color="blue")
plt.plot(x, p_2, label="P2: 1 + x", color="gray")
plt.plot(x, p_3, label="P3: 1 + x - (1/3)x^3", color="yellow")
plt.plot(x, p_4, label="P4: 1 + x - (1/3)x^3 - (1/6)x^4", color="dark")
plt.plot(x, p_5, label="P5: 1 + x - (1/3)x^3 - (1/6)x^4 - (1/30)x^5", color="purple")
...
plt.plot(xnew, L1(xnew), label=r"$L_1(x)$", color="darkred", linestyle="-", linewidth=2)
plt.plot(xnew, L2(xnew), label=r"$L_2(x)$", color="darkblue", linestyle="--", linewidth=2)
plt.plot(xnew, L3(xnew), label=r"$L_3(x)$", color="darkgreen", linestyle="-.", linewidth=2)
plt.plot(xnew, L4(xnew), label=r"$L_4(x)$", color="orange", linestyle=":", linewidth=2)
...
plt.plot(x_values,  poli_spCond(x_values), label="Spline Condicionado", color="red")
...
plt.plot(x_values,  poliLagrange(x_values), label="Lagrange")
plt.plot(x_values,  poli_spnat(x_values), label="Spline Natural")
plt.plot(x_values,  poli_spCond(x_values), label="Spline Condicionado", color="orange")
plt.plot(x, y,'o', label="Nodos")
...
plt.plot(x_values,  poliLagrange(x_values), label="Lagrange")
plt.plot(x_values,  poli_spnat(x_values), label="Spline Natural")
plt.plot(x_values,  poli_spCond(x_values), label="Spline Condicionado", color="blue")
plt.plot(x, y,'o', label="Nodos")
...
plt.figure(figsize=(8,5))
plt.plot(xnew,  poliLagrange(xnew), label="Lagrange", color="red")
plt.plot(xnew,  poli_spnat(xnew), label="Spline natural", color="yellow")
plt.plot(x, y,'o', label="Nodos")
...
plt.figure(figsize=(8,5))
plt.plot(xnew,  poli_spnat(xnew), label="Spline natural", color="orange")
plt.plot(x, y,'o', label="Nodos")
...
for n in n_val:
  ...
  plt.plot(x_plot, poli_spCond(x_plot), label = f"Spline n={n}", color="red")
  plt.plot(x_nodos, y_nodos,'o', label="Nodos")
...
for n in n_val:
  ...
  poli_spCond=CubicSpline(x_nodos,y_nodos, bc_type =((1,f_der(a)),(1,f_der(b))))
  plt.plot(x_plot, poli_spCond(x_plot), label = f"Spline n={n}")
  plt.plot(x_nodos, y_nodos,'o', label="Nodos", color="orange")
